...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Chamo Tour Destinations</h1>
	</div>
</div>
...
<div class="rooms">
 ...
 <?php $sql = "SELECT * FROM  tbltourdestinations order by rand() limit 3";
