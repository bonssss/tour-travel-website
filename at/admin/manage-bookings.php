...
<html>
<head>
<title>Chamo Tour | Admin manage Bookings</title>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Bookings</h2>
						...
						<tbody>
<?php $sql = "SELECT tblbooking.BookingId as bookid,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tbltourdestinationss.DestinationName as desname,tblbooking.DestinationId as did,tblbooking.FromDate as fdate,tblbooking.ToDate as tdate,tblbooking.Comment as comment,tblbooking.status as status,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate from tblusers join  tblbooking on  tblbooking.UserEmail=tblusers.EmailId join tbltourdestinations on tbltourdestinations.DestinationId=tblbooking.DestinationId";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>		
						  <tr>
							...
							<td><a href="update-destination.php?pid=<?php echo htmlentities($result->pid);?>"><?php echo htmlentities($result->pckname);?></a></td>
