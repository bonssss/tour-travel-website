...
$sql="update TblTourDestinations set DestinationImage=:dimage where DestinationId=:imgid";
$query = $dbh->prepare($sql);

$query->bindParam(':imgid',$imgid,PDO::PARAM_STR);
$query->bindParam(':dimage',$pimage,PDO::PARAM_STR);
$query->execute();
...
<html>
<head>
<title>Chamo Tour | Admin Destination Creation</title>
  ...
  <div class="grid-form1">
  	       <h3>Update Destination Image </h3>
  	         ...
  	         <div class="tab-content">
						...
						<?php 
$imgid=intval($_GET['imgid']);
$sql = "SELECT DestinationImage from TblTourDestinations where DestinationId=:imgid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="destinationimages/<?php echo htmlentities($result->DestinationImage);?>" width="200">
</div>
</div>
