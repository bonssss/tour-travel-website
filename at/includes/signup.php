...
$sql="INSERT INTO  tblusers(FullName,PhoneNumber,EmailId,Password) VALUES(:fname,:pnumber,:email,:password)";
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				...
				<input type="text" value="" placeholder="Phone number" maxlength="10" name="phonenumber" autocomplete="off" required="">
